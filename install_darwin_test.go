...
func TestShellRCFileNoHome(t *testing.T) {
	t.Setenv("HOME", "")
...
func TestAddToShellPathFish(t *testing.T) {
	home := t.TempDir()
	t.Setenv("HOME", home)
...
func TestAddToShellPathBash(t *testing.T) {
	home := t.TempDir()
	t.Setenv("HOME", home)
...
func TestAddToShellPathIdempotent(t *testing.T) {
